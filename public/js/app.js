...
window.smoothScroll = __webpack_require__(33);
...
!function (a, b) {
  ...
  }, r.isArray = Array.isArray, r.parseJSON = JSON.parse, r.nodeName = B, "function" == "function" && __webpack_require__(35) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
    return r;
...
var _loop = function _loop() {
  ...
  var prevButton = scrollers[i].querySelector('.scroller-previous');
  ...
  function themeScroll(direction) {
    ...
    var newScroll = scrollerInner.scrollLeft - scrollerInner.clientWidth * .5 * dir;
