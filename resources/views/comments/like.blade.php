<div class="like-container">
	...
	<span id="{{ $like_item->id }}-{{ get_class($like_item) }}-like-total" class="like-total">@if($like_item->likes->sum('vote') > 0)+{{$like_item->likes->sum('vote')}} @else {{ $like_item->likes->sum('vote') }} @endif</span>
